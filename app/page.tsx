      ...
      <aside className="sidebar">
        ...
        <nav>
          {navItems.map(({ label, icon: Icon }) => (
            <button className={`nav-item ${active === label ? "active" : ""}`} key={label} onClick={() => label === "Inquéritos" ? router.push("/investigations") : label === "Pessoas" ? router.push("/people") : setActive(label)}>
